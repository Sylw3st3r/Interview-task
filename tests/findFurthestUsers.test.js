import {
    getDistance,
    getAllUserDistanceCombinations,
    findFurthestUsers,
} from "../src/findFurthestUsers.js";
...
describe("function - getAllUserDistanceCombinations", () => {
    test("Check if all posible combinations are created", () => {
        const allCombinations = [
            { user1: user1, user2: user2, distance: 0 },
            { user1: user1, user2: user3, distance: 0 },
            { user1: user2, user2: user3, distance: 0 },
        ];
        expect(getAllUserDistanceCombinations([user1, user2, user3])).toEqual(
            allCombinations
        );
    });
...
describe("function - findFurthestUsers", () => {
    test("Check if finds the furthest par of users", () => {
        ...
        expect(findFurthestUsers(users)).toEqual({
            user1: user1,
            user2: user4,
            distance: 15012.08,
        });
